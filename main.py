...
USER_ID = ''
TOKEN = "BQBXAQXFsvkrfyzd-fQ4F09AecPyLv0kJZC6UHl4IRXgQaeiRIZ1iM2m59kfsJfGKCQNH4C1cuRmEEEdK8Vq9lUADLEmvi_NwqtqEez3zRMC-48kK6MXlTX4ptza6AzIekbfQfat-Tfex66Y6qhU643lbYNTJXaZVMErEikH"
...
if __name__ == "__main__":
    ...
    r = requests.get("https://api.spotify.com/v1/me/player/recently-played?after{time}".format(
        time=yesterday_unix_time), headers=headers)
